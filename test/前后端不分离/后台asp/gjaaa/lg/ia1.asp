...
'2、打开表
exec="select top 1 * from a2 order by id desc"
...
<%do while not rs.eof%>
<div id="nftfsua211" style=" display: block; width:768px; height:30px;border:1px solid #2266aa; line-height:30px; font-size:9px;"><%=rs("bt2")%></div>
	   	 <%rs.movenext
loop
'1、关闭表
rs.close
